                ...
                <div className="carousel-inner">
                        ...
                        <div className="container">
                            <div className="row p-5">
                                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                                    <img className="img-fluid" src={require("../assets/img/banner_img_01.jpg")} alt="" />
                                </div>
                    ...
                    <div className="carousel-item">
                        <div className="container">
                            <div className="row p-5">
                                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                                    <img className="img-fluid" src={require("../assets/img/banner_img_02.jpg")} alt="" />
                                </div>
                                <div className="col-lg-6 mb-0 d-flex align-items-center">
                    ...
                    <div className="carousel-item">
                        <div className="container">
                            <div className="row p-5">
                                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                                    <img className="img-fluid" src={require("../assets/img/banner_img_03.jpg")} alt=""/>
                                </div>
                                <div className="col-lg-6 mb-0 d-flex align-items-center">
                                    <div className="text-align-left">
            ...
            <section className="container py-5">
                ...
                <div className="row">
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="#"><img src={require("../assets/img/category_img_01.jpg")} className="rounded-circle img-fluid border" /></a>
                        <h5 className="text-center mt-3 mb-3">Watches</h5>
                        <p className="text-center"><a className="btn btn-success">Go Shop</a></p>
                    </div>
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="#"><img src={require("../assets/img/category_img_02.jpg")} className="rounded-circle img-fluid border"/></a>
                        <h2 className="h5 text-center mt-3 mb-3">Shoes</h2>
                        <p className="text-center"><a className="btn btn-success">Go Shop</a></p>
                    </div>
                    <div className="col-12 col-md-4 p-5 mt-3">
                        <a href="#"><img src={require("../assets/img/category_img_03.jpg")} className="rounded-circle img-fluid border"/></a>
                ...
                <div className="container py-5">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 mb-4">
                            <div className="card h-100">
                                <a href="shop-single.html">
                                    <img src={require("../assets/img/feature_prod_01.jpg")} className="card-img-top" alt="..."/>
                                </a>
                        ...
                        <div className="col-12 col-md-4 mb-4">
                            <div className="card h-100">
                                <a href="shop-single.html">
                                    <img src={require("../assets/img/feature_prod_02.jpg")} className="card-img-top" alt="..."/>
                                </a>
                                <div className="card-body">
                                    <ul className="list-unstyled d-flex justify-content-between">
                                        <li>
                        ...
                        <div className="col-12 col-md-4 mb-4">
                            <div className="card h-100">
                                <a href="shop-single.html">
                                    <img src={require("../assets/img/feature_prod_03.jpg")} className="card-img-top" alt="..."/>
                                </a>
                                <div className="card-body">
                                    <ul className="list-unstyled d-flex justify-content-between">
                                        <li>
